<template>
    <div class="container mx-auto pt-32 pb-32 px-5 min-h-screen flex flex-col justify-center items-start">
        ...
        <hr class="h-[1px] w-full my-8 bg-gray-400/50 dark:bg-gray-700 border-0 rounded md:my-12">
        ...
        <div class="skills w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div class="skill">
                    <img src="../assets/img/skill/css3.svg" alt="Nuxt.js">
                    CSS3
                </div>
                <div class="skill">
                    <img src="../assets/img/skill/javascript.svg" alt="Nuxt.js">
                    JavaScript
                </div>
                <div class="skill">
                ...
                <div class="skill">
                    <img src="../assets/img/skill/tailwindcss.svg" alt="">
                    TailwindCSS
                </div>
                <div class="skill">
                ...
                <div class="skill">
                    <img src="../assets/img/skill/php.svg" alt="">
                    PHP
                </div>
                <div class="skill">
        ...
        <ul class="list-none flex flex-col gap-2">
            <li class="flex items-center flex-wrap">Hosted on <img src="../assets/img/icons/cloudflarepages.svg" class="w-5 mx-2" />Cloudflare Pages</li>
            <li class="flex items-center flex-wrap">Powered by <img src="../assets/img/skill/nuxtdotjs.svg" class="w-5 mx-2" /> Nuxt.js and <img src="../assets/img/skill/tailwindcss.svg" class="w-5 mx-2" />TailwindCSS</li>
